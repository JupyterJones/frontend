...
import axios from 'axios'; // Removed AxiosError since it's not being used
import './AskForm.css'
...
function AskForm() {
  ...
  return (
    ...
    <div className="ask-form-container">
      <h2 style={{ width: '90%', textAlign: 'center' }}>Ask Gemini about ReactJS / AskForm.tsx</h2>
      <p style={{ width: '90%', textAlign: 'center' }}>Question and Answer: Stored in ChromaDB AskForm</p>
      <form onSubmit={handleSubmit}>
        <textarea 
          ...
          style={{ width: '98%', height: '100px',marginBottom: '10px', marginRight: '10px', padding: '3px' }} // Basic styling
        />
        <br />
        <button
          type="submit"
