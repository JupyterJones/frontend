  ...
  return (
    <Router>
      <div className="App" style={{ width: '93%', textAlign: 'center', marginTop: '10px', marginRight:'auto', marginLeft: 'auto', padding: '5px', border: '1px solid #eee',  borderRadius: '5px', backgroundColor: 'darkred',color: 'yellow' }}>
        ...
        <Link to="/ChatInterface" style={{ color: 'lightblue', marginRight: '10px' }} >ChatInterface</Link> {/* Changed the Link to /history */}
          <button onClick={handleReloadFiles} style={{ marginLeft: '10px', padding: '8px 12px' }}>Reload Files</button>


        <Link to="/StockDataComponent" style={{ color: 'lightblue', marginRight: '10px' }} >StockDataComponent</Link> {/* Changed the Link to /history */}
          <button onClick={handleReloadFiles} style={{ marginLeft: '10px', padding: '8px 12px' }}>Reload Files</button>      
        </nav>
        <hr />
        <Routes>
          ...
          <Route path="/ChatInterface" element={<ChatInterface />} /> {/* Changed the path to /ChatInterface */}
          <Route path="/StockDataComponent" element ={<StockDataComponent />} /> {/* Changed the path to /StockData */}
        </Routes><br/>
        <YouTubeVideo />
      </div>
    </Router>
